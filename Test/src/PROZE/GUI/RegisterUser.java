...
public class RegisterUser extends javax.swing.JPanel {
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        ...
        if ((email.equals(email2)) && (Arrays.equals(firstPassword, secondPassword))) {
            ...
            JOptionPane.showMessageDialog(frame, "Pole \"E-mail\" i \"Powtórz e-mail\" są  różne uzupełnij je jeszcze raz");
        } else if ((email.equals(email2)) && !(Arrays.equals(firstPassword, secondPassword))) {
            JOptionPane.showMessageDialog(frame, "Pole \"Hasło\" i \"Powtórz hasło\" są  różne uzupełnij je jeszcze raz");
        } else if (!(email.equals(email2)) && !(Arrays.equals(firstPassword, secondPassword))) {
            JOptionPane.showMessageDialog(frame, "Pole \"E-mail\" i \"Powtórz e-mail\" są różne oraz pola\"Hasło\" i \"Powtórz hasło\" są różne uzupełnij je ponownie");
        }
